...
#### 1. Systems + Automation - infrastructure and scripting skills.
 - Linux/Raspberry Pi setup to provision users, deploy software, and collect logs
...
#### 3. Hardware + Software - end-to-end hardware-software understanding.
 - [Moonrat](https://github.com/PubInv/moonrat) – open-source portable incubator for field engineers and scientists. Full design → circuit → firmware → interaction. **Includes a published scientific paper**
...
#### 4. Frontend/Interactive projects 
 - [SustainTulsa](https://github.com/melanielaporte/SustainTulsa) HTML/CSS/JS coded frontend project demonstrating interactivity and UI design
